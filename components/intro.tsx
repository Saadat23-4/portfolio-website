...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">{"Hello, I'm Saadat."}</span> {"I'm a"}{" "}
        <span className="font-bold">Front-end developer </span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        building <span className="italic">websites</span>. My focus is{" "}
        <span className="underline">React, JavaScript(TypeScript)</span>
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/saadat-nurbek-82b6bb234/"
          title="LinkedIn"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Saadat23-4"
          title="GitHub"
        >
          <FaGithubSquare />
        </a>
